	...
	_createClass(YAxis, [{
		...
		value: function render() {
			var _props = this.props,
			    ...
			    moreProps = _objectWithoutProperties(_props, ['axisAt', 'showTicks', 'showGridLine']);

			var yScale = this.context.yScale;

			return _react2.default.createElement(_BaseAxis2.default, _extends({ axisAt: axisAt, type: 'YAxis', showTicks: showTicks, scale: yScale, showGridLine: showGridLine }, moreProps));
		}
	}]);
