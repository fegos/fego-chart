  ...
  function Coordinate() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Coordinate.__proto__ || Object.getPrototypeOf(Coordinate)).call.apply(_ref, [this].concat(args))), _this), _this._updateTicksInfo = function () {
      var _this$props = _this.props,
          ...
          tickOffsetX = _this$props.tickOffsetX,
          tickOffsetY = _this$props.tickOffsetY,
          tickHeight = _this$props.tickHeight,
          tickWidth = _this$props.tickWidth,
          isTickCenter = _this$props.isTickCenter;
            ...
            if (actualData) {
              ticks = xTicks.map(function (tick, i) {
                ...
                if (actualData[tick]) {
                  ...
                  var x = centerX - tickOffsetX + offset;
                  var y = topOffset;
                  if (position === 'bottom') {
                    y = frame.height + bottomOffset;
                  }
...
Coordinate.propTypes = {
  ...
  // tick宽度
  tickWidth: _propTypes2.default.number,
  // tick高度
  tickHeight: _propTypes2.default.number,
  // x轴ticks偏移量
  tickOffsetX: _propTypes2.default.number,
  // y轴ticks偏移量
  tickOffsetY: _propTypes2.default.number,
  // 左侧offset
  ...
  // tick位置是否居中
  isTickCenter: _propTypes2.default.bool };
