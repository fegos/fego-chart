...
var BaseTooltip = function (_Component) {
  ...
  _createClass(BaseTooltip, [{
    ...
    value: function componentWillReceiveProps(nextProps, nextContext) {
      ...
      if ((preEvents.longPressEvent === null || events.longPressEvent === null) && preEvents.longPressEvent !== events.longPressEvent) {
        shouldRedraw = true;
...
BaseTooltip.propTypes = {
  ...
  // 指标
  indicators: _propTypes2.default.arrayOf(_propTypes2.default.string),
  // 指标名
