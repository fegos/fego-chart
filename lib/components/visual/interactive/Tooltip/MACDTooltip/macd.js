...
var macdTooltip = function (_Component) {
  ...
  function macdTooltip() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = macdTooltip.__proto__ || Object.getPrototypeOf(macdTooltip)).call.apply(_ref, [this].concat(args))), _this), _this.formatIndicators = function (indicators) {
  ...
  _createClass(macdTooltip, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_BaseTooltip2.default, _extends({ title: 'MACD', type: 'group', valueKeys: valueKeys }, this.props, { indicators: indicators }));
    }
  }]);
